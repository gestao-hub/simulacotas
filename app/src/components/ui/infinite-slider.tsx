...
export function InfiniteSlider({
  ...
  const effectiveHoverDuration = speedOnHover ? 1000 / speedOnHover : durationOnHover;
  ...
  const hoverProps = effectiveHoverDuration
    ? {
        onHoverStart: () => { setIsTransitioning(true); setCurrentDuration(effectiveHoverDuration); },
