...
export default function PropostaPreview({ html, open, onClose, onWhatsApp }: Props) {
  ...
  const handleDownload = () => {
    ...
    if (win) {
      ...
      // Fallback mobile: download como arquivo HTML
  ...
  return (
    <Dialog open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogContent showCloseButton={false} className="sm:max-w-2xl h-[90vh] flex flex-col p-0 gap-0 overflow-hidden">
        {/* Header */}
        ...
        <div className="flex-1 overflow-auto bg-gray-100 p-4">
          <div className="mx-auto max-w-[595px] rounded-xl bg-white shadow-lg overflow-hidden">
            {html && (
              <iframe
                ref={iframeRef}
                srcDoc={html}
